...
export default function LeadsBySourceList() {
  ...
  const data = [
    { id: 1, source: "Facebook", leadsAdded: 0, followupLeads: 0 },
    { id: 2, source: "Google", leadsAdded: 0, followupLeads: 0 },
    { id: 3, source: "Instagram", leadsAdded: 2, followupLeads: 2 },
    { id: 4, source: "Internet", leadsAdded: 1, followupLeads: 1 },
    { id: 5, source: "Helo", leadsAdded: 0, followupLeads: 0 },
  ];
            ...
            <tbody>
              {data.map((item) => (
                ...
                >
                  ...
                  <td className="py-2 px-4 border">{item.source}</td>
